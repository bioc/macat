...
evalScoring <- function(data,class,chromosome,nperms=1000,permute="labels",subset=NULL,newlabels=NULL,kernel=rbf,kernelparams=NULL,step.width=100000,memory.limit=TRUE){
